"""
Python generator into java POJO
"""
...
class SimpleType:
    """
    SimpleType class
    This is to override dynamically created classes with user supplied classes
    """
...
def get_entity_mm():
    ...
    """
    type_builtins = {"integer": SimpleType(None, "integer"), "string": SimpleType(None, "string")}
...
def main(debug=False):
    ...
    for entity in person_model.entities:
        ...
        with open(join(srcgen_folder, "%s.java" % entity.name.capitalize()), "w") as f:
